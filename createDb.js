var commands = [
    ...
    "CREATE TABLE transactions(TransactionId varchar(255), Owner varchar(255), Type varchar(255), Amount varchar(255), Date datetime NOT NULL, PRIMARY KEY(TransactionId), FOREIGN KEY(owner) REFERENCES users(IdNumber));",

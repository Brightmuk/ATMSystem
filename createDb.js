var commands = [
    ...
    "CREATE TABLE transactions(TransactionId varchar(255), Owner varchar(255), Type varchar(255), Amount varchar(255), PRIMARY KEY(TransactionId), FOREIGN KEY(owner) REFERENCES users(IdNumber));",
        "INSERT INTO transactions(TransactionId, Owner, Type, Amount) VALUES ('001','37789587','Deposit',3000);"
]